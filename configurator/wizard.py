...
[dim]Press Ctrl+C at any time to cancel.[/dim]
    ...
    def _select_profile(self) -> str:
        ...
        self.console.print("1. 🟢 [green]Beginner[/green] - Quick setup with safe defaults (Recommended)")
    ...
    def _configure_basic(self):
        ...
        if tz_choice == "9":
            self.config["system"]["timezone"] = Prompt.ask(
        ...
        self.console.print(
            f"[green]✓ Timezone: {self.config['system']['timezone']}[/green]\n"
        )
    ...
    def _confirm_installation(self) -> bool:
        ...
        self.console.print("[yellow]   Make sure you have a backup or snapshot of your VPS.[/yellow]\n")
