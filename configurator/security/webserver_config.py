...
class NginxConfigurator:
    ...
    def generate_ssl_snippet(self, tls_config: Optional[TLSConfig] = None) -> str:
        ...
        snippet = f"""# SSL/TLS Configuration
...
"""
    ...
    def configure_site(
        ...
        self.logger.info(f"✅ Nginx configured for {domain}")
        return True
...
class ApacheConfigurator:
    ...
    def generate_site_config(
        ...
        vhost = f"""# HTTP to HTTPS redirect
<VirtualHost *:80>
    ServerName {domain}
